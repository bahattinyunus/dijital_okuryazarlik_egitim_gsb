...
<div class="lesson-badge"><span class="number">4</span><span class="label">Ders</span></div>
...
- 🎯 Net hedef: Formun amacı ve hedef kitleni baştan belirle
- 🧭 Akış: Genel → Spesifik sırayla, az sayıda zorunlu soru
- ✅ Tutarlılık: Kısa, anlaşılır metin ve seçenekler
- 🔗 Mantık atlaması: Gerektiğinde dallandır, gereksiz soruları gizle
- 📊 Analiz: Sheets entegrasyonu ve grafiklerden yararlan
- ♿ Erişilebilirlik: Yeterli kontrast, açık etiketler ve yardım metinleri
