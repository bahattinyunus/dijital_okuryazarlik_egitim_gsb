...
## 📚 Genel Bakış
Bu dizin, GSB Gençlik Merkezlerinde düzenlenen 12 saatlik Dijital Okuryazarlık Eğitimi'nin tüm içeriklerini organize eder.
...
├── INDEX.md                           # Bu dosya (içerik dizini)
├── ders_notlari/                      # Tüm ders planları ve notları
│   ├── 01_canva/
│   ├── 02_google_docs/
│   ├── 03_google_slides/
│   ├── 04_google_forms/
...
- [x] Bulut tabanlı araçları kullanabilme
- [x] Grafik tasarım temellerini kavrama
- [x] Dijital işbirliği yapabilme
- [x] Proje yönetimi becerilerini geliştirme

### İçerik Üretimi
- [x] Görsel tasarım (Canva)
- [x] Metin üretimi (Google Docs)
- [x] Sunum hazırlama (Google Slides)
- [x] Video düzenleme (CapCut)

### Dijital Güvenlik ve Etik
- [x] Siber güvenlik farkındalığı
- [x] Dijital ayak izi bilinci
- [x] Etik içerik paylaşımı
- [x] Bilgi kirliliği ile mücadele

### Yapay Zeka Okuryazarlığı
- [x] AI araçlarını tanıma
- [x] Prompt yazma teknikleri
- [x] Verimli AI kullanımı
- [x] AI etiği farkındalığı
...
- **Teknik**: Bilgisayar/tablet, internet bağlantısı
- **Hesaplar**: Google, Canva, Trello hesapları
- **Malzemeler**: Projeksiyon, ses sistemi
- **Zaman**: Her ders için 15 dakika hazırlık

### Değerlendirme Araçları
- **Pratik Projeler**: Her derste uygulamalı ödev
- **Grup Çalışmaları**: İşbirliği becerilerini ölçme
- **Portfolyo**: Tüm çalışmaların dijital koleksiyonu
- **Öz Değerlendirme**: Öğrenci geri bildirim formları

### Öğrenci Takibi
- **Katılım Listesi**: Her ders için devam takibi
- **Proje Teslimi**: Deadline ve kalite takibi
- **Beceri Gelişimi**: Kişisel ilerleme raporları
- **Sertifika**: 12 saati tamamlayan öğrenciler için
...
### Platform Linkleri
- [Canva](https://www.canva.com/) - Grafik tasarım
- [Google Workspace](https://workspace.google.com/) - Üretkenlik araçları
- [Trello](https://trello.com/) - Proje yönetimi
- [Notion](https://www.notion.so/) - Not alma ve organizasyon
- [CapCut](https://www.capcut.com/) - Video düzenleme
- [ChatGPT](https://chat.openai.com/) - AI asistan

### Eğitim Videoları
- [Canva Tasarım Okulu](https://www.canva.com/designschool/)
- [Google Workspace Eğitimleri](https://workspace.google.com/learning-center/)
- [Siber Güvenlik 101](https://www.coursera.org/learn/cybersecurity-basics)
- [AI Ethics Course](https://www.edx.org/course/artificial-intelligence-ethics)

### Ücretsiz Kaynaklar
- [Unsplash](https://unsplash.com/) - Ücretsiz stok fotoğraflar
- [Pixabay](https://pixabay.com/) - Ücretsiz görseller ve videolar
- [Coolors](https://coolors.co/) - Renk paleti oluşturma
...
- **Ders Sayısı**: 12 adet
- **Pratik Proje**: 24+ örnek
- **Araç/Platform**: 8 farklı platform
- **Hedef Kitle**: Lise düzeyi gençler

### Başarı Kriterleri
- **%80+** katılım oranı
- **Min 8/12** ders tamamlama
- **Min 1** proje her derste
- **Portfolyo** oluşturma
- **Akran değerlendirmesi** yapma
...
1. **Fork** yapın ve yeni özellikler ekleyin
2. **Issue** açarak sorunları bildirin
3. **Pull Request** göndererek iyileştirme önerinizi paylaşın
4. **Geri bildirim** formunu doldurun

### İletişim
- **Eğitmen**: Bahattin Yunus Çetin
...
|-------|----------|---------------|
| 2024-11-19 | v1.0 | İlk sürüm - temel yapı oluşturuldu |
| 2024-11-19 | v1.1 | Klasör yapısı ve şablonlar eklendi |
| - | v1.2 | Tüm ders planları tamamlanacak |
| - | v2.0 | Video içerikler eklenecek |
...
> 💡 **Not**: Bu eğitim materyali sürekli güncellenmektedir. En son sürüm için repository'yi takip edin.